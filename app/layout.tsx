  ...
  return (
    <html lang="en" suppressHydrationWarning>
      ...
      <body className="min-h-screen bg-background text-text-primary antialiased">
        <ThemeProvider>
          <a href="#main-content" className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-[60] focus:px-4 focus:py-2 focus:bg-primary focus:text-primary-foreground focus:rounded-lg">
