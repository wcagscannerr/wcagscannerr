...
export const metadata: Metadata = {
  title: 'Contact | WCAG Scanner',
  description: 'Get in touch with WCAG Scanner for support, bug reports, or agency inquiries. We typically respond within 24 hours on business days.',
  openGraph: {
    title: 'Contact | WCAG Scanner',
    description: 'Get in touch with WCAG Scanner for support, bug reports, or agency inquiries. We typically respond within 24 hours on business days.',
    url: 'https://www.wcagscannerr.com/contact',
